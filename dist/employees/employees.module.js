...
const api_reniec_1 = require("./service/api-reniec");
...
exports.EmployeesModule = EmployeesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([employees_entity_1.Employees])],
        controllers: [employees_controller_1.EmployeesController],
        providers: [employees_service_1.EmployeeService, api_reniec_1.ApiReniecDataService],
